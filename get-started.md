...
```jsonc
{
  ...
  "scripts": {
    "comments-yourapp-prod": {
      "path": "https://raw.githubusercontent.com/skymethod/minipub/v0.1.0/worker.ts",
      "bindings": {
...
You can define users, create comments, federate activities using the Minipub [admin rpc api](https://github.com/skymethod/minipub/blob/v0.1.0/cli.ts#L31), or the `minipub` cli which wraps it.
